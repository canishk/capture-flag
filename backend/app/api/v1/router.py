...
from app.modules.achievements.api.router import router as achievements_router
...
from app.modules.leaderboards.api.router import router as leaderboards_router
...
from app.modules.trophies.api.router import router as trophies_router
...
api_router.include_router(trophies_router)
